...
class RestaurentsSearchField extends StatelessWidget {
  const RestaurentsSearchField({
    super.key,
  });
        ...
        child: Form(
          child: TextFormField(
            ...
            onChanged: (value) {
              context
                  .read<AttributesBloc>()
                  .add(SearchRestaurants(text: controller.text));
            },
            onEditingComplete: () {
              context
                  .read<AttributesBloc>()
                  .add(SearchStores(text: controller.text));
            },
